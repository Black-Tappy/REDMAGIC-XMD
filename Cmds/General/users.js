module.exports = async (context) => {
  ...
  try {
    ...
    const response = await fetch("https://api.github.com/repos/Black-Tappy/REDMAGIC-XMD");
    ...
    if (repoData) {
      ...
      const messageText = `
        *A Total of ${modifiedForks} People are using REDMAGIC-XMD.*

        *${modifiedStars} People have starred it as a sign of Loving it.*

        *KEEP USING REDMAGIC-XMD*
